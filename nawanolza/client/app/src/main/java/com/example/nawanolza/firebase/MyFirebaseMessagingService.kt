package com.example.nawanolza.firebase
...
//            Log.d(TAG, remoteMessage.data["body"].toString())
    ...
    private fun sendNotification(remoteMessage: RemoteMessage) {
        ...
        val pendingIntent = PendingIntent.getActivity(this, uniId, intent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
        // 알림 채널 이름
